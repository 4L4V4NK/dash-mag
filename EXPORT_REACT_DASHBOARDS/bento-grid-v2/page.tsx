 ...
 * 
 * New version combining:
 * - Bento Grid layout (compact, modular, grouped)
 * - Golden Ratio proportions (Φ ≈ 1.618)
 * - Fibonacci spacing and sizing
 * - Responsive breakpoints
 * 
 * Features: Interactive blocks, chart hiding, AI Assistant
...
import styles from './BentoGridV2.module.css';
